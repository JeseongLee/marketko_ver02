...
DROP TABLE CATEGORY;
DROP TABLE DEAL_BOARD_CONTENT_IMG;
...
CREATE TABLE DEAL_BOARD(
	...
	DEAL_BOARD_THUMBNAIL VARCHAR2(500) NOT NULL,
...
--판매글이미지
CREATE TABLE DEAL_BOARD_CONTENT_IMG(
	DEAL_BOARD_CONTENT_IMG_NAME VARCHAR2(100) PRIMARY KEY,
	DEAL_BOARD_NUMBER NUMBER NOT NULL,
	DEAL_BOARD_CONTENT_IMG_PATH VARCHAR2(500) NOT NULL,
...
CREATE TABLE EVALUATION_IMG(
	...
	EVALUATION_NUMBER NUMBER NOT NULL,
	EVALUATION_IMG_PATH VARCHAR2(500) NOT NULL,
